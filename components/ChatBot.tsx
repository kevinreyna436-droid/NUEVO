...
const ChatBot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    { id: '1', role: 'model', text: 'Hello! I am your textile expert. Ask me about trends, cleaning codes, or suppliers.' }
  ]);
  ...
  const handleSend = async () => {
    ...
    const modelMsg: ChatMessage = { 
      ...
      role: 'model', 
      text: result.text || "I couldn't find an answer.",
      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 z-50 w-80 sm:w-96 bg-white rounded-3xl shadow-2xl border border-gray-100 flex flex-col h-[500px] overflow-hidden animate-fade-in-up">
          <div className="bg-primary p-4 text-white">
            <h3 className="font-serif text-lg">Creata Assistant</h3>
            <p className="text-xs text-gray-300">Powered by Gemini 3 Pro</p>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-50">
            ...
            {loading && <div className="flex justify-start"><div className="bg-gray-200 p-3 rounded-2xl rounded-bl-none text-xs text-gray-500 animate-pulse">Thinking...</div></div>}
          ...
          <div className="p-3 bg-white border-t border-gray-100 flex">
            ...
            />
            <button onClick={handleSend} className="ml-2 bg-black text-white p-2 rounded-full">
